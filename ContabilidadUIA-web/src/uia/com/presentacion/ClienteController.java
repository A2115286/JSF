		...
		// TODO Auto-generated method stub
		 throws ServletException, IOException {
		        ...
		        else if (action.equalsIgnoreCase("verCheques"))
		        {
		            ...
		            String clienteId = request.getParameter("clienteName");
		            request.setAttribute("cliente", clienteId);
		            request.setAttribute("listaCompras", dao.getCompras(clienteId));//se ve compras
		            request.setAttribute("listaCuentas", dao.getCuentas(clienteId));
		            request.setAttribute("listaCheques", dao.getCheques(clienteId));
